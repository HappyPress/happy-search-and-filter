/**
 * Happy Search & Filter Advanced Filter JavaScript
 */
(function($) {
    'use strict';
    ...
    function initAdvancedFilter() {
        ...
        $('.hbl-filter-toggle').on('click', function() {
            ...
            if ($('.hbl-advanced-filter-form').hasClass('hbl-show-filters')) {
                $toggleText.text(hsfAdvancedFilter.i18n.hideFilters || 'Hide Filters');
            } else {
                $toggleText.text(hsfAdvancedFilter.i18n.showFilters || 'Show Filters');
            }
        });
        ...
        $('.hbl-advanced-filter-form').on('submit', function(e) {
            ...
            var form = $(this);
            var resultsContainer = $('#hsf-search-results');
            ...
            var data = {
                action: 'hsf_advanced_filter_results',
    ...
    function initLocationSearch() {
        ...
        if (navigator.geolocation) {
            ...
            var $useMyLocation = $('<button type="button" class="hbl-use-my-location">' + (hsfAdvancedFilter.i18n.useMyLocation || 'Use my location') + '</button>');
            ...
            $useMyLocation.on('click', function(e) {
                ...
                navigator.geolocation.getCurrentPosition(function(position) {
                    ...
                    $('#hsf-filter-latitude').val(lat);
                    $('#hsf-filter-longitude').val(lng);
    ...
    function loadSavedFilters() {
        ...
        if (Object.keys(savedFilters).length === 0) {
            $savedFiltersList.html('<p class="hbl-no-saved-filters">' + (hsfAdvancedFilter.i18n.noSavedFilters || 'No saved filters yet.') + '</p>');
            return;
        }
    ...
    function saveCurrentFilter() {
        ...
        var filterName = prompt(hsfAdvancedFilter.i18n.saveFilterPrompt || 'Enter a name for this filter:');
        ...
        if (filterName) {
            ...
            localStorage.setItem('hsf_saved_filters', JSON.stringify(savedFilters));
    ...
    function getSavedFilters() {
        var savedFilters = localStorage.getItem('hsf_saved_filters');
